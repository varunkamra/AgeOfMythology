...
/**
 * AI class for Egyptian player.
 * 
 * @author varun
 *
 */

public class ArtificialIntelligenceEgyptian extends ArtificialIntelligence {

	public ArtificialIntelligenceEgyptian(PlayerBoard playerBoard, Player player) {
		...
		for (int i = 0; i < terrianTiles.size(); i++) {
			if (terrianTiles.get(i).getTerrianType().equals("Desert")) {
				if (terrianMatrix[0][0] == null || !terrianMatrix[0][0]
						|| terrianMatrix[0][1] == null || !terrianMatrix[0][1]
						|| terrianMatrix[1][1] == null || !terrianMatrix[1][1]
						|| terrianMatrix[2][0] == null || !terrianMatrix[2][0]
						|| terrianMatrix[2][1] == null || !terrianMatrix[2][1]
						|| terrianMatrix[3][0] == null || !terrianMatrix[3][0]) {
	...
	public void placeVictoryCards() {
		Random random = new Random();
		int victoryCardNumber = random.nextInt(4);
	}
