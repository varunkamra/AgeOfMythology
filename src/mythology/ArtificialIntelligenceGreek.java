...
/**
 * AI class for greek player.
 * 
 * @author varun
 *
 */

public class ArtificialIntelligenceGreek extends ArtificialIntelligence {

	public ArtificialIntelligenceGreek(PlayerBoard playerBoard, Player player) {
